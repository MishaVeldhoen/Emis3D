...
class TestBivariateNormal:
    ...
    def test_normalisation(self):
        ...
        vals = bivariate_normal(RR.ravel(), ZZ.ravel(), R0=0.0, z0=0.0, pol_sigma=0.5)
    ...
    def test_peak_at_centre(self):
        ...
        RR, ZZ = np.meshgrid(R, z, indexing="ij")
        vals = bivariate_normal(RR.ravel(), ZZ.ravel(), R0=2.0, z0=0.0, pol_sigma=0.3)
    ...
    def test_symmetry(self):
        ...
        for delta in [0.1, 0.3, 0.7]:
            v_plus  = bivariate_normal(np.array([R0 + delta]), np.array([z0]), R0=R0, z0=z0, pol_sigma=sig)
            v_minus = bivariate_normal(np.array([R0 - delta]), np.array([z0]), R0=R0, z0=z0, pol_sigma=sig)
    ...
    def test_positive_everywhere(self):
        ...
        vals = bivariate_normal(RR.ravel(), ZZ.ravel(), R0=2.0, z0=0.0, pol_sigma=0.5)
    ...
    def test_array_input(self):
        ...
        vals = bivariate_normal(R, z, R0=2.0, z0=0.0, pol_sigma=1.0)
        assert vals.shape == (3,)
