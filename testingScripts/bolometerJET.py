...
using the example from: https://www.cherab.info/demonstrations/bolometry/calculate_etendue.html
"""
...
from raysect.optical.material import AbsorbingSurface  # type: ignore
...
SLIT_WIDTH = 0.04607
SLIT_HEIGHT = 0.02
FOIL_WIDTH = 0.005537  # width of the diode
FOIL_HEIGHT = 0.00304056  # height of the diode
FOIL_CORNER_CURVATURE = 0.0005
SLIT_SENSOR_SEPARATION = 0.155468  # distance between the slit and the diode array
FOIL_SEPARATION = 0.0  # 0 mm between diodes (only one foil)
...
ax.errorbar(
    x=foil_number, y=raytraced_etendues, yerr=raytraced_errors, label="Ray-traced"
)
ax.legend()
